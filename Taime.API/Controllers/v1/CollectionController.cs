...
namespace Taime.API.Controllers.v1
{
    ...
    public class CollectionController : ControllerBase
    {
        ...
        [HttpGet]
        [SwaggerResponse((int)HttpStatusCode.OK, Type = typeof(ResultData<List<CollectionResponse>>)),
        ...
        [HttpGet("{id}")]
        [SwaggerResponse((int)HttpStatusCode.OK, Type = typeof(ResultData<CollectionResponse>)),
        SwaggerResponse((int)HttpStatusCode.BadRequest, Type = typeof(ErrorData)),
        SwaggerResponse((int)HttpStatusCode.Unauthorized, Type = typeof(ErrorData))]
